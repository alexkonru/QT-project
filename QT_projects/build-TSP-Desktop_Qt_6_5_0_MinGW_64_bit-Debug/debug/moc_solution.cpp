...
Q_CONSTINIT static const qt_meta_stringdata_CLASSsolutionENDCLASS_t qt_meta_stringdata_CLASSsolutionENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(9, 6),  // "solved"
        QT_MOC_LITERAL(16, 0),  // ""
        QT_MOC_LITERAL(17, 16),  // "std::vector<int>"
        QT_MOC_LITERAL(34, 5),  // "close"
        QT_MOC_LITERAL(40, 12)   // "save_to_file"
    },
    "solution",
    "solved",
    "",
...
void solution::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->solved((*reinterpret_cast< std::add_pointer_t<std::vector<int>>>(_a[1]))); break;
        ...
        {
            using _t = void (solution::*)(std::vector<int> );
            if (_t _q_method = &solution::solved; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void solution::solved(std::vector<int> _t1)
{
